...
?>
<?= $this->buildBreadCrumbs(array('取消')); ?>
	<section class="container">
	<form action="<?=ViewBase::getUrl('order/transitdeliveryorder/back',['id'=>$info->id]);?>" class="frm model_<?=$model?>" method="POST" data-component="async">
		<table class="frm-tbl">
			<tbody>
				   <tr>
					   <td><?=t('选择原因')?></td>
	               ...
	               <tr class="">
	                   <td  class="col-label"><em>*</em><?=t('取消原因')?></td>

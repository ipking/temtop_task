                            ...
                            <table id="<?=$item->id?>" width="100%" class="location-tbl">
                                ...
                                foreach($put as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td width="40"><input type='number' class="txt real_qty" min="0" step="1" name="items[<?=$item->id?>][real_qty][]" value="<?=$row->qty?>" required='required' title=""/></td>
